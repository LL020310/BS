...
type ChiNavigationProp = StackNavigationProp<RootStackParamList, 'Chi'>;

type Props = {
  navigation: ChiNavigationProp;
  route: { params: { greeting?: string } };
};

const Chi = ({ route }: Props) => {
  const { greeting } = route.params || {};

  return (
    <View style={styles.container}>
      <Text style={styles.text}>
        {greeting || 'Welcome to the Chinese Learning Page!'}
      </Text>
