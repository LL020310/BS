...
type BMNavigationProp = StackNavigationProp<RootStackParamList, 'BM'>;

type Props = {
  navigation: BMNavigationProp;
  route: { params: { greeting?: string } };
};

const BM = ({ route }: Props) => {
  const { greeting } = route.params || {};

  return (
    <View style={styles.container}>
      <Text style={styles.text}>
        {greeting || 'Selamat datang ke halaman Pembelajaran Bahasa Melayu!'}
      </Text>
